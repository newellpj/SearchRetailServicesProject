...
public class RssAndSearchFilterTest {
	...
	public void testReadRSSFeedNoTextSearchWithPagination(){
		...
		FeedMessage[] feedMessages = rssHandler.readRSSFeedPaginatedSync("https://www.nasa.gov/rss/dyn/lg_image_of_the_day.rss", mockSession, true, true, null, -1);
		...
		feedMessages = rssHandler.readRSSFeedPaginatedSync("https://www.nasa.gov/rss/dyn/lg_image_of_the_day.rss", mockSession, true, true, null, -1);
	...
	public void testReadRSSFeedTextSearchWithPagination(){
		...
		FeedMessage[] feedMessages = rssHandler.readRSSFeedPaginatedSync("https://www.nasa.gov/rss/dyn/lg_image_of_the_day.rss", mockSession, true, true, searchFilter, -1);
		System.out.println("Feed messages length : "+feedMessages.length);
		assertNotNull(feedMessages);
		assertTrue(feedMessages.length > 0);
