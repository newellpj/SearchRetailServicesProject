...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="./presentationResources/css/styles.css">
  ...
  <script type="text/javascript" language="javascript" charset="utf-8" src="./presentationResources/js/nav.js"></script>
<!--[if lt IE 9]>
